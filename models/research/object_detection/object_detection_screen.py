...
def detection_function_box(THRESHOLD, NUM_CLASSES, PROJECT, MODEL, top, left, width, height):
...
def detection_function_mrcnn(THRESHOLD, NUM_CLASSES, PROJECT, top, left, width, height):
    root_mod = os.path.abspath(os.sep)
    obj_det_mod = os.path.join(root_mod, 'tensorflow_app', 'models', 'research', 'object_detection')
...
def main(MODEL, THRESHOLD, NUM_CLASSES, PROJECT, top, left, width, height):
    if MODEL == 'faster':
        detection_function_box(THRESHOLD, NUM_CLASSES, PROJECT, 'faster', top, left, width, height)
    elif MODEL == 'ssd':
        detection_function_box(THRESHOLD, NUM_CLASSES, PROJECT, 'ssd', top, left, width, height)
    else:
        detection_function_mrcnn(THRESHOLD, NUM_CLASSES, PROJECT, top, left, width, height)
